...
- **Alliance**: Joined
- **Season**: 🛢️ Oil War (S2)
- **Goal**: Keep all Squad 1 heroes at **Lv.120 / ★4** | T8 troops ASAP 🎯
...
|-------|-----|------|-------|
| **Queue 1** | HQ Lv.25 🚧 | → Barrier Lv.23 | → Alliance Support Center Lv.24 |
| **Queue 2** | Barracks Lv.24 🚧 | → **Lv.25** (use speedups!) | → Hospital upgrade |
...
|----------|--------|-------------|
| **🏗️ Construction Minister** | 건설 속도 대폭 증가 | HQ 25 / 병영 25 연속 건설 시 |
...
Front Right : Murphy       (UR Tank/Tanker   / Lv.120 / ★4)
Front Left  : Williams     (UR Tank/Tanker   / Lv.120 / ★3)

Back  Right : Kimberly     (UR Tank/Dealer   / Lv.120 / ★4)
Back  Center: Marshall     (UR Tank/Support  / Lv.120 / ★3)
Back  Left  : Stetmann     (UR Tank/Dealer   / Lv.120 / ★1) 🆕 Violet OUT!
```

> 🎉 Stetmann 스왓 완료! [YouTube](https://www.youtube.com/watch?v=qcWhAx4RiDQ)
...
Front Left  : Lucius       (UR Aircraft/Tanker / Lv.71  / ★0)

Back  Right : DVA          (UR Aircraft/Dealer / Lv.100 / ★2)
Back  Center: Schuyler     (UR Aircraft/Dealer / Lv.72  / ★0)
Back  Left  : Morrison     (UR Aircraft/Dealer / Lv.71  / ★0)
```
